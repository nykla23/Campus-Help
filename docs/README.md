...
| 页面         | 预览                               |
| ------------ | ---------------------------------- |
| 登录/注册页  | ![](images/screenshot-login.png)  |
| 首页任务列表 | ![](images/screenshot-home.jpg)   |
| 发布任务页   | ![](images/screenshot-publish.jpg) |
| 任务详情页   | ![](images/screenshot-task.jpg)   |
| 消息/聊天页  | ![](images/screenshot-chat.jpg)   |
| 个人中心     | ![](images/screenshot-profile.jpg) |
| AI 智能客服  | ![](images/screenshot-ai.jpg)     |
